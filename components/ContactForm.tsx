    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-full flex items-center justify-center bg-white flex-shrink-0">
          ...
          <div className="flex-1 text-white">
            <h3 className="font-semibold text-lg mb-1">Contactez-moi sur WhatsApp</h3>
            <p className="text-sm text-white/80">Réponse rapide, échanges simplifiés</p>
          </div>
          <a
