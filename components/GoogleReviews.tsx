    ...
    <section className="section-padding overflow-hidden" style={{ background: "var(--bg-cream)" }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="overflow-hidden">
          ...
          <div 
            className="flex gap-4 pb-4 overflow-x-auto scrollbar-hide touch-pan-x md:hidden"
            style={{ 
              WebkitOverflowScrolling: "touch",
              scrollSnapType: "x mandatory",
            }}
          >
            {duplicatedReviews.slice(0, reviews.length).map((review, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-[280px] sm:w-[320px] p-5 rounded-2xl"
                style={{ 
                  background: "white",
          ...
          <div className="hidden md:flex gap-6 animate-scroll">
          {duplicatedReviews.map((review, index) => (
            <div
              key={index}
              className="flex-shrink-0 w-[400px] p-6 rounded-2xl transition-all hover:shadow-lg"
              style={{ 
                background: "white",
                boxShadow: "0 4px 20px rgba(0,0,0,0.05)",
              }}
